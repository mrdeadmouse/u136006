...
if (COption::GetOptionString("intranet", "use_tasks_2_0", "N") == "Y")
	...
	$arComponentProps = CComponentUtil::GetComponentProps("bitrix:intranet.tasks_list", $arCurrentValues);

$arParameters = Array(
	"PARAMETERS" => Array(
		"PAGE_VAR" => $arComponentProps["PARAMETERS"]["PAGE_VAR"],
		"GROUP_VAR" => $arComponentProps["PARAMETERS"]["GROUP_VAR"],
		"VIEW_VAR" => $arComponentProps["PARAMETERS"]["VIEW_VAR"],
...
if (COption::GetOptionString("intranet", "use_tasks_2_0", "N") != "Y")
	$arParameters["PARAMETERS"]["IBLOCK_ID"] = $arComponentProps["PARAMETERS"]["IBLOCK_ID"];

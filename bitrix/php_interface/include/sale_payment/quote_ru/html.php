...
<table width="100%">
	...
	<tr>
		<td><?if($sellerInfo['ADDRESS']):?>Адрес: <?=$sellerInfo['ADDRESS']?><?endif;?></td>
		<td><?if($customerInfo['ADDRESS']):?>Адрес: <?=$customerInfo['ADDRESS']?><?endif;?></td>
	</tr>
	<tr>
	...
	<tr>
		<td><?if($sellerInfo['BANK']):?>Банк: <?=$sellerInfo['BANK_CITY'] ? ($sellerInfo['BANK'].', '.$sellerInfo['BANK_CITY']) : $sellerInfo['BANK']?><?endif;?></td>
		<td></td>
	</tr>
	<tr>

...
$arFields['PATH_TO_LEAD_CONVERT'] = CComponentEngine::MakePathFromTemplate($arParams['PATH_TO_LEAD_CONVERT'],
	array(
		'lead_id' => $arFields['~ID']
	)
);
...
if (!$CCrmLead->cPerms->HavePerm('QUOTE', BX_CRM_PERM_NONE, 'READ'))
{

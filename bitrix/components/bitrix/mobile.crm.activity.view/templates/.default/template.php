			...
			<?if($storageTypeID === \Bitrix\Crm\Integration\StorageType::Disk && !empty($diskFiles)):?>
				...
				<div class="crm_files">
					<ul>
						...
						<li>
							<a href="#" onclick="app.openDocument({ url: '<?=htmlspecialcharsbx(SITE_DIR."mobile/disk/{$diskFileInfo['ID']}/download/?".__CrmActivityViewPrepareNameForJson($diskFileInfo['NAME']))?>' }); return false;">

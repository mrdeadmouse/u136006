...
$activityEditorUID = isset($arParams['ACTIVITY_EDITOR_UID']) ? $arParams['ACTIVITY_EDITOR_UID'] : '';
if($activityEditorUID === '')
{
	$activityEditorUID = 'crm_'.strtolower(CCrmOwnerType::ResolveName($entityTypeID)).'_'.$entityID.'_feed_activity_editor';
}
$arResult['ACTIVITY_EDITOR_UID'] = $arParams['ACTIVITY_EDITOR_UID'] = $activityEditorUID;

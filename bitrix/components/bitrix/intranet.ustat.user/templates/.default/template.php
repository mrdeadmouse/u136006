...
<? endif ?>
	...
	graph2.balloonText = '<?=CUtil::JSEscape(str_replace("\n", " ", $arResult['USERS_INFO'][$arParams['USER_ID']]['FULL_NAME']))?>: [[value]]';
	...
	graph3.balloonText = '<?=GetMessageJS('INTRANET_USTAT_USER_GRAPH_DEPT', array('%DEPT%' => $arResult['DEPARTMENT_TITLE']))?>: [[value]]';

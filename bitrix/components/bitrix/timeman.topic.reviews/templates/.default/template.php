...
?>
		...
		<?php foreach ($arResult["COMMENTS"] as $res):?>
			<div class="timeman-comment">
				<span class="timeman-comment-avatar"<?php if ($res["AUTHOR_PHOTO"]):?> style="background:url('<?php echo $res["AUTHOR_PHOTO"]["CACHE"]["src"]?>') no-repeat center center;"<?php endif?>></span>

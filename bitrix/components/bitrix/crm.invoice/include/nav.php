...
if (!isset($arResult['INTERNAL']) || !$arResult['INTERNAL'])
{
	...
	{
		$APPLICATION->AddChainItem(GetMessage('CRM_INVOICE_NAV_TITLE_LIST'), $arParams['PATH_TO_INVOICE_LIST']);
	...
	{
		$APPLICATION->SetTitle(GetMessage('CRM_INVOICE_NAV_TITLE_LIST'));
	}
}
?>
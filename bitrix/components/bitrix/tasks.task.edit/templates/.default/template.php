				...
				<div class="webform-row task-dates-row">
					<div class="webform-field webform-field-round-corners">
						<div class="webform-round-corners">
							...
							<div class="webform-content">
								<div class="webform-field task-deadline-settings"><label for="task-deadline-date"><?php echo GetMessage("TASKS_TASK_DEADLINE") ?>:</label><span class="webform-field webform-field-textbox webform-field-textbox-clearable<?php echo (!$arData["DEADLINE"] ? " webform-field-textbox-empty" : "") ?> task-deadline-date"><span class="webform-field-textbox-inner"><input type="text" id="task-deadline-date" class="webform-field-textbox" name="DEADLINE" value="<?php echo tasksTimeCutZeros($arData["DEADLINE"]) ?>" readonly="readonly" data-default-time="<?=intval($arResult['COMPANY_WORKTIME']['END']['H'])?>:<?=intval($arResult['COMPANY_WORKTIME']['END']['M'])?>:0" /><a class="webform-field-textbox-clear" href=""></a></span></span><a href="" class="webform-field-action-link task-planning-dates-link" id="task-planning-dates-link"><?php echo GetMessage("TASKS_TASK_PERION_PLANING") ?></a><span class="task-reminder<?php if ($arData["REMINDERS"]):?> task-reminder-selected<?php endif?>"><a href="" class="webform-field-action-link task-reminder-link" id="task-reminder-link"><?php echo GetMessage("TASKS_TASK_REMIND") ?></a></span></div>

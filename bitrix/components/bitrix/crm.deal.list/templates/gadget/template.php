...
else
{
	foreach($arResult['DEAL'] as &$arDeal)
	{
		...
		echo '<script type="text/javascript">BX.tooltip("DEAL_', $arDeal['~ID'], '", "', $linkID,'", "/bitrix/components/bitrix/crm.deal.show/card.ajax.php", "crm_balloon_no_photo", true);</script>';
		echo '</div>';

...
if ($companyID > 0 && !$CCrmContact->cPerms->HavePerm('COMPANY', BX_CRM_PERM_NONE, 'READ'))
{
...
if (!$CCrmContact->cPerms->HavePerm('QUOTE', BX_CRM_PERM_NONE, 'READ'))
{
...
if (!$CCrmContact->cPerms->HavePerm('INVOICE', BX_CRM_PERM_NONE, 'READ'))
{
...
$arResult['FIELDS']['tab_activity'][] = array(
	...
	'componentData' => array(
		...
		'enableLazyLoad' => true,
		'params' => array(
			'BINDINGS' => array(array('TYPE_NAME' => 'CONTACT', 'ID' => $arParams['ELEMENT_ID'])),

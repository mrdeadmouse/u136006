if(typeof(BX.CrmContactView) === 'undefined')
{
	BX.CrmContactView = function()
	{
		this._id = '';
		this._settings = {};
	...
	if(typeof(BX.CrmContactView.messages) === 'undefined')
	{
		BX.CrmContactView.messages = {};
	}

	BX.CrmContactView.prototype =
	{
		...
		{
			var items = BX.CrmContactView.messages;
		...
		_onExternalCreate: function(eventArgs)
		{
			...
			if((typeName === BX.CrmActivityModel.typeName && BX.CrmActivityModel.checkBindings(BX.CrmContactModel.typeName, this.getEntityId(), data))
				|| (typeName === BX.CrmDealModel.typeName && BX.CrmDealModel.checkContact(this.getEntityId(), data)))
			{
				this._isDirty = true;
			}
		},
		_onExternalUpdate: function(eventArgs)
		{
			...
			if((typeName === BX.CrmContactModel.typeName && id === this.getEntityId())
				|| (typeName === BX.CrmActivityModel.typeName && BX.CrmActivityModel.checkBindings(BX.CrmContactModel.typeName, this.getEntityId(), data))
				|| (typeName === BX.CrmDealModel.typeName && BX.CrmDealModel.checkContact(this.getEntityId(), data)))
			{
				this._isDirty = true;
			}
		...
		_onExternalDelete: function(eventArgs)
		{
			...
			else if((typeName === BX.CrmActivityModel.typeName && BX.CrmActivityModel.checkBindings(BX.CrmContactModel.typeName, this.getEntityId(), data))
				|| (typeName === BX.CrmDealModel.typeName && BX.CrmDealModel.checkContact(this.getEntityId(), data)))
			{
				this._isDirty = true;
			}
	...
	BX.CrmContactView.items = {};
	BX.CrmContactView.create = function(id, settings)
	{
		var self = new BX.CrmContactView();

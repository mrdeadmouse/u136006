...
<div class="meeting-question-tasks-wrap">
	<div class="meeting-question-tasks-top">
		...
		<span class="meeting-link" onclick="ShowQuickTask()"><?=GetMessage('MI_TASK_ADD')?></span><span class="meeting-link" onclick="showTaskSelector(this)"><?=GetMessage('MI_TASK_ATTACH')?></span>
	</div>
</div>

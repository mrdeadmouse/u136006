			...
			switch($key)
			{
				...
				case 'PERSONAL_PHOTO':
					if (!$arResult['USERS'][$i][$key])
						$arResult['USERS'][$i][$key] = '<div class="user-avatar"></div>';
					else
					{
						...
						$arResult['USERS'][$i][$key] = "<div class='user-avatar' style='background: url(\"".$arFileTmp["src"]."\") no-repeat center center;'></div>";
					}
				break;

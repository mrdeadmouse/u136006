...
<div class="timeman-container planner-container<?=(IsAmPmMode() ? " am-pm-mode" : "")?>"><?
	?><div class="timeman-wrap planner-wrap"><?
		?><span id="timeman-block" class="timeman-block"><?
			?><span class="bx-time" id="timeman-timer"><script type="text/javascript">document.write(plannerFormatCurrentTime(new Date().getHours(), new Date().getMinutes()))</script></span><?

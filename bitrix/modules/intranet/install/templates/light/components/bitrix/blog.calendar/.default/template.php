...
<?if(!empty($arResult["CALENDAR"]))
{
	...
	<div class="sidebar-block">
		...
		<div class="sidebar-block-title"><?=GetMessage("BLOG_BLOG_CLNDR_TITLE")?></div>
		<table border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
			<td align="center">
				<table class="sidebar-blog-calendar-table">
					<tr>
				...
				<table border="0" cellspacing="0" cellpadding="2" class="sidebar-blog-calendar-table">
					<tr>
					...
					foreach($arResult["CALENDAR"] as $k=>$v)
					{
						...
						{
							?>
							<tr><td colspan="7"><div class="sidebar-blog-calendar-line"></div></td></tr>
							<?
						}
						?>
						<tr>

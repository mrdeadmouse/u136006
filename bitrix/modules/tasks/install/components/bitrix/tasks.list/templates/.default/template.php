...
<?//setting pre-order for sub-tasks?>
setPreOrder(<?=CUtil::PhpToJSObject($arParams['PREORDER'])?>);
</script>
<?php
if (
	...
	>
		...
		<tbody>
			...
			<tr class="task-list-item task-list-item-hidden" id="task-new-item-row">
				...
				?>
				<td class="task-new-item-column" colspan="<?php if ($firstColumnWidth == 0) echo ($tableColumnsCount - 1); else echo $tableColumnsCount; ?>">

...
function AddTask()
{
	...
	var description = BX('task-new-item-description').value;
...
{
	var link = null, row = BX("task-" + taskId);

	if ( ! row )
		return;

	if (BX('task-title-btn-menu-' + taskId))
		link = BX.findChild(BX('task-title-btn-menu-' + taskId), {tagName : "a"});

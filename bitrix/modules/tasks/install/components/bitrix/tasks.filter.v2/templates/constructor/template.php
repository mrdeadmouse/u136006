...
BX.ready(function(){
	...
	oEngine.renderer = {
		...
		__createValueSelector : function(itemMeta, itemType, selectedValue)
		{
			...
			{
				var valuesMap = oEngine.renderer.phrases.prioritiesMap;
				var objValueSelector = new this.__createListValueSelector(valuesMap, itemMeta, selectedValue);
			}
			else if (
				(itemType === 'CREATED_BY')
	...
	oEngine.renderer.phrases.fieldsPhrases = {
		...
		'PRIORITY'       : '<?php echo GetMessageJs('TASKS_FIELD_PRIORITY'); ?>',
	...
	oEngine.renderer.phrases.prioritiesMap = [
		{
			phrase : '<?php echo GetMessageJs('TASKS_FILTERV2_CONSTRUCTOR_PRIORITY_LOW'); ?>',
			value  : <?php echo CTasks::PRIORITY_LOW; ?>
		},
		{
			phrase : '<?php echo GetMessageJs('TASKS_FILTERV2_CONSTRUCTOR_PRIORITY_AVERAGE'); ?>',
			value  : <?php echo CTasks::PRIORITY_AVERAGE; ?>
		},
		{
			phrase : '<?php echo GetMessageJs('TASKS_FILTERV2_CONSTRUCTOR_PRIORITY_HIGH'); ?>',

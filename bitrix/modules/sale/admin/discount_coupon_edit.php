...
if ($subWindow)
{
	...
	$control = new CAdminSubForm('saleSubCouponControl', $tabList, false, true, $listUrl, false);
}
else
{
	if ($multiCoupons)
		$control = new CAdminForm('saleMultiCouponControl', $tabList);
	else
		$control = new CAdminForm('saleCouponControl', $tabList);

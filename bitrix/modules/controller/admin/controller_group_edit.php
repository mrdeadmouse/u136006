...
if (isset($_REQUEST["copy_id"]) && $_REQUEST["copy_id"] > 0)
{
	...
	if ($arGroupFields = $mb->ExtractFields("str_"))
		$ID = 0;
}
...
<?$tabControl->BeginNextTab();?>
	...
	<?endif?>
	<?if(strlen($str_DATE_CREATE)>0 && !$copy_id):?>
	<tr>
	...
	<? endif; ?>
	<?if(strlen($str_TIMESTAMP_X)>0 && !$copy_id):?>
	<tr>
...
<?$tabControl->BeginNextTab();?>
	...
	<tr>
		<td><textarea style="width:100%" rows="15" wrap="OFF" name="INSTALL_PHP" id="INSTALL_PHP"><?echo $str_INSTALL_PHP?></textarea></td>
	</tr>
	<tr>
		<td><?echo GetMessage("CTRLR_GR_ED_PHP_UNINST")?></td>
	</tr>
	<tr>
		<td><textarea style="width:100%" rows="15" wrap="OFF" name="UNINSTALL_PHP" id="UNINSTALL_PHP"><?echo $str_UNINSTALL_PHP?></textarea></td>
	</tr>
<?
if(
	(count($USER_FIELD_MANAGER->GetUserFields($ENTITY_ID)) > 0) ||

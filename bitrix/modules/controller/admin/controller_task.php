...
while($arRes = $rsData->Fetch())
{
	...
	$row->AddViewField("CONTROLLER_MEMBER_NAME", '<a href="controller_member_edit.php?ID='.urlencode($arRes["CONTROLLER_MEMBER_ID"]).'">'.htmlspecialcharsEx($arRes["CONTROLLER_MEMBER_NAME"]).'</a>');
...
<tr>
	<td>ID:</td>
	<td><input type="text" name="find_id" value="<?echo htmlspecialcharsbx($_REQUEST["find_id"])?>" size="47"><?//=ShowFilterLogicHelp()?></td>
</tr>
<tr>
	<td><?=GetMessage("CTRLR_TASK_FLT_CLIENT")?>:</td>
	<td><input type="text" name="find_controller_member_id" value="<?echo htmlspecialcharsbx($_REQUEST["find_controller_member_id"])?>" size="47"><?//=ShowFilterLogicHelp()?></td>
</tr>
<tr>
...
<tr>
	...
	<td><?echo CalendarPeriod("find_executed_from", $_REQUEST["find_executed_from"], "find_executed_to", $_REQUEST["find_executed_to"], "form1", "Y")?></td>
</tr>
<tr>
	<td><?=GetMessage("CTRLR_TASK_FLT_MODYFIED")?>:</td>
	<td><?echo CalendarPeriod("find_timestamp_x_from", $_REQUEST["find_timestamp_x_from"], "find_timestamp_x_to", $_REQUEST["find_timestamp_x_to"], "form1", "Y")?></td>
</tr>
<tr>
	<td><?=GetMessage("CTRLR_TASK_FLT_CREATED")?>:</td>
	<td><?echo CalendarPeriod("find_created_from", $_REQUEST["find_created_from"], "find_created_to", $_REQUEST["find_created_to"], "form1", "Y")?></td>
</tr>

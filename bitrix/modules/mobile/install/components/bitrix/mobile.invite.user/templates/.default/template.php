	...
	<table width="100%" cellpadding="5">
		<tr valign="bottom">
			<td colspan="2">
				...
				<textarea rows="5" type="text" name="EMAIL" id="EMAIL" class="invite-user-textarea"><?if ($arResult["SUCCESS"] != "Y") echo htmlspecialcharsbx($_POST["EMAIL"])?></textarea>
			</td>
		</tr>
		<tr valign="bottom">
			<td colspan="2">
				<div><label for="MESSAGE_TEXT" class="invite-user-label"><?echo GetMessage("BX24_INVITE_DIALOG_INVITE_MESSAGE_TITLE")?></label></div>
				<textarea rows="5" type="text" name="MESSAGE_TEXT" id="MESSAGE_TEXT" class="invite-user-textarea"><?

				...
				<tr>
					<td style="padding:5px;" align="middle">
						...
						<table cellpadding="0">
							<tr>
								<td style="vertical-align: top;">
									...
									<div class="bx-text-left" style="float: left;width: 70%;text-align:left">
										<div style="padding: 5px;">
											<b>Lorem ipsum</b>
						...
						<table cellpadding="0">
							<tr>
								<td style="vertical-align: top;">
									<div class="bx-images-left" style="float: left;width: 30%;text-align:left">
										<div style="padding: 5px;">
											<img height="auto" style="max-width:100%;height:auto;" src="/bitrix/images/sender/preset/default_cube.png">
										</div>
									</div>
									<div class="bx-text-right" style="float: left;width: 70%;text-align:left">
										<div style="padding: 5px;">
											<b>Lorem ipsum</b>
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse</p>
										</div>

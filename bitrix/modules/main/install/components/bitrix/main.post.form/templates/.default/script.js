...
window.onKeyDownHandler = function(e, editor, formID)
{
	...
	if(MPFMention.listen)
	{
		...
		{
			BX.SocNetLogDestination.selectCurrentSearchItem(window['BXSocNetLogDestinationFormNameMent' + formID]);
			editor.iframeKeyDownPreventDefault = true;
			BX.PreventDefault(e);
		}
		else if (keyCode == editor.KEY_CODES["left"])
		{
			BX.SocNetLogDestination.moveCurrentSearchItem(window['BXSocNetLogDestinationFormNameMent' + formID], 'left');
			editor.iframeKeyDownPreventDefault = true;
			BX.PreventDefault(e);
		}
		else if (keyCode == editor.KEY_CODES["right"])
		{
			BX.SocNetLogDestination.moveCurrentSearchItem(window['BXSocNetLogDestinationFormNameMent' + formID], 'right');
			editor.iframeKeyDownPreventDefault = true;
			BX.PreventDefault(e);
		}
		else if (keyCode == editor.KEY_CODES["up"])
		{
			BX.SocNetLogDestination.moveCurrentSearchItem(window['BXSocNetLogDestinationFormNameMent' + formID], 'up');
			editor.iframeKeyDownPreventDefault = true;
			BX.PreventDefault(e);
		}
		else if (keyCode == editor.KEY_CODES["down"])
		{
			BX.SocNetLogDestination.moveCurrentSearchItem(window['BXSocNetLogDestinationFormNameMent' + formID], 'down');
			editor.iframeKeyDownPreventDefault = true;
			BX.PreventDefault(e);
		}
	}

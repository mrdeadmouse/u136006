...
HTML
	...
	public function show($values = array())
	{
		...
		$canEdit = ($this->elementSetts["edit"] && $this->elementSetts["description"] ? '' : 'adm-fileinput-non-edit');
		...
		if ($this->uploadSetts["allowUpload"] == "I")
			$hintMessage = Loc::getMessage("BXU_DNDMessage1");
		else if ($this->uploadSetts["allowUpload"] == "F")
			$hintMessage = Loc::getMessage("BXU_DNDMessage2", array("#ext#" => $this->uploadSetts["allowUploadExt"]));
		else
			$hintMessage = Loc::getMessage("BXU_DNDMessage3");

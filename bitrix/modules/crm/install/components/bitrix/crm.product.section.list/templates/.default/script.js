...
BX.CrmProductSectionManager.prototype =
{
    ...
    addSection: function()
    {
        ...
        var dlg = this._dialogs['ADD']['POPUP'] = new BX.PopupWindow(
            ...
            null,
            {
                ...
                titleBar:
                {
                    content: this._prepareSectionAddDialogTitle()
                },
                events:
                {
    ...
    _prepareSectionAddDialogTitle: function()
    {
        return BX.create(
            'SPAN',
            {
                html: this.getMessage('addDialogTitle'),
                props: { className: 'bx-crm-dialog-title' }
            }
        );
    },
    ...
    renameSection: function(id, name)
    {
        ...
        var dlg = this._dialogs['RENAME']['POPUP'] = new BX.PopupWindow(
            ...
            null,
            {
                ...
                titleBar:
                {
                    content: this._prepareSectionRenameDialogTitle()
                },
                events:
                {
                    onPopupShow: function()
    ...
    _prepareSectionRenameDialogTitle: function()
    {
        return BX.create(
            'SPAN',
            {

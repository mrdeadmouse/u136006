...
class CCrmDocument
{
	...
	static public function GetDocumentFieldTypes($documentType)
	{
		...
		$ignoredUserTypes = array('string', 'double', 'boolean', 'integer', 'datetime', 'file', 'employee', 'enumeration', 'video', 'string_formatted', 'webdav_element_history', 'disk_version');

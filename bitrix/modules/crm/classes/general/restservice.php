...
class CCrmProductRestProxy extends CCrmRestProxyBase
{
	...
	public static function registerEventBindings(array &$bindings)
	{
		...
		$bindings[CRestUtil::EVENTS]['onCrmProductAdd'] = array('catalog', 'OnProductAdd', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmProductUpdate'] = array('catalog', 'OnProductUpdate', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmProductDelete'] = array('iblock', 'OnAfterIBlockElementDelete', $callback);
	}
...
class CCrmLeadRestProxy extends CCrmRestProxyBase
{
	...
	public static function registerEventBindings(array &$bindings)
	{
		...
		$bindings[CRestUtil::EVENTS]['onCrmLeadAdd'] = array('crm', 'OnAfterCrmLeadAdd', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmLeadUpdate'] = array('crm', 'OnAfterCrmLeadUpdate', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmLeadDelete'] = array('crm', 'OnAfterCrmLeadDelete', $callback);
	}
	public static function processEvent(array $arParams, array $arHandler)
	{
...
class CCrmDealRestProxy extends CCrmRestProxyBase
{
	...
	public static function registerEventBindings(array &$bindings)
	{
		...
		$bindings[CRestUtil::EVENTS]['onCrmDealAdd'] = array('crm', 'OnAfterCrmDealAdd', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmDealUpdate'] = array('crm', 'OnAfterCrmDealUpdate', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmDealDelete'] = array('crm', 'OnAfterCrmDealDelete', $callback);
	}
	public static function processEvent(array $arParams, array $arHandler)
	{
...
class CCrmCompanyRestProxy extends CCrmRestProxyBase
{
	...
	public static function registerEventBindings(array &$bindings)
	{
		...
		$bindings[CRestUtil::EVENTS]['onCrmCompanyAdd'] = array('crm', 'OnAfterCrmCompanyAdd', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmCompanyUpdate'] = array('crm', 'OnAfterCrmCompanyUpdate', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmCompanyDelete'] = array('crm', 'OnAfterCrmCompanyDelete', $callback);
	}
	public static function processEvent(array $arParams, array $arHandler)
	{
...
class CCrmContactRestProxy extends CCrmRestProxyBase
{
	...
	public static function registerEventBindings(array &$bindings)
	{
		...
		$bindings[CRestUtil::EVENTS]['onCrmContactAdd'] = array('crm', 'OnAfterCrmContactAdd', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmContactUpdate'] = array('crm', 'OnAfterCrmContactUpdate', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmContactDelete'] = array('crm', 'OnAfterCrmContactDelete', $callback);
	}
	public static function processEvent(array $arParams, array $arHandler)
	{
...
class CCrmCurrencyRestProxy extends CCrmRestProxyBase
{
	...
	public static function registerEventBindings(array &$bindings)
	{
		...
		$bindings[CRestUtil::EVENTS]['onCrmCurrencyAdd'] = array('currency', 'OnCurrencyAdd', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmCurrencyUpdate'] = array('currency', 'OnCurrencyUpdate', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmCurrencyDelete'] = array('currency', 'OnCurrencyDelete', $callback);
	}
	public static function processEvent(array $arParams, array $arHandler)
	{
		$eventName = $arHandler['EVENT_NAME'];
...
class CCrmActivityRestProxy extends CCrmRestProxyBase
{
	...
	public static function registerEventBindings(array &$bindings)
	{
		...
		$bindings[CRestUtil::EVENTS]['onCrmActivityAdd'] = array('crm', 'OnActivityAdd', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmActivityUpdate'] = array('crm', 'OnActivityUpdate', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmActivityDelete'] = array('crm', 'OnActivityDelete', $callback);
	}
	public static function processEvent(array $arParams, array $arHandler)
	{
		$eventName = $arHandler['EVENT_NAME'];
